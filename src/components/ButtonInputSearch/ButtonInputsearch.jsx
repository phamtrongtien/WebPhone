    ...
    return (
        <div style={{ display: 'flex' }}>
            <InputComponent
                ...
                variant="filled"
                {...props}
                style={{ marginTop: '10px', backgroundColor: backgroundColorInput, borderTopRightRadius: '0px', borderBottomRightRadius: '0px', borderTopLeftRadius: '20px', borderBottomLeftRadius: '20px' }}>
